...
local utils = require("src.widgets.volume.utils")
...
local widget_types = {
    icon_and_text = require("src.widgets.volume.widgets.icon-and-text-widget"),
    icon = require("src.widgets.volume.widgets.icon-widget"),
    arc = require("src.widgets.volume.widgets.arc-widget"),
    horizontal_bar = require("src.widgets.volume.widgets.horizontal-bar-widget"),
    vertical_bar = require("src.widgets.volume.widgets.vertical-bar-widget")
}
local volume = {}
